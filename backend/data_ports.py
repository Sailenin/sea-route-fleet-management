# Major world ports + Indian ports focus
PORTS = [
    # Asia-Pacific
    {'id': 1, 'name': 'Shanghai', 'lat': 31.2304, 'lon': 121.4737, 'region': 'East Asia', 'type': 'major'},
    {'id': 2, 'name': 'Singapore', 'lat': 1.3521, 'lon': 103.8198, 'region': 'SE Asia', 'type': 'major'},
    {'id': 9, 'name': 'Tokyo', 'lat': 35.6762, 'lon': 139.6503, 'region': 'East Asia', 'type': 'major'},
    {'id': 8, 'name': 'Sydney', 'lat': -33.8688, 'lon': 151.2093, 'region': 'Oceania', 'type': 'major'},
    
    # India & Indian Ocean (FOCUS)
    {'id': 10, 'name': 'Mumbai (Bombay)', 'lat': 19.0760, 'lon': 72.8777, 'region': 'India (West)', 'type': 'major'},
    {'id': 11, 'name': 'Chennai', 'lat': 13.1939, 'lon': 80.2705, 'region': 'India (South)', 'type': 'major'},
    {'id': 12, 'name': 'Kolkata (Calcutta)', 'lat': 22.5726, 'lon': 88.3639, 'region': 'India (East)', 'type': 'major'},
